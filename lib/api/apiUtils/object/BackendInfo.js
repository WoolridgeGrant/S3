    ...
    */
    ...
    static controllingBackendParam(objectLocationConstraint,
        ...
        if (objectLocationConstraint &&
            ...
            return { isValid: false, locationContraintValue: 'object' };
        }
        if (bucketLocationConstraint &&
            ...
            return { isValid: false, locationContraintValue: 'bucket' };
        }
        if (requestEndpoint &&
            !BackendInfo.isValidRequestEndpoint(requestEndpoint, log)) {
            return { isValid: false, locationContraintValue: 'endpoint' };
        }
        return { isValid: true };
    }
