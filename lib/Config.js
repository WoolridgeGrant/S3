...
class Config {
    ...
    _getConfig() {
        ...
        this.antidote = {};
        if (config.antidote) {
			//This hashmap contains (port, host) couples

			console.log("LE port utilise par antidote : " + config.antidote.port);
			this.antidote[config.antidote.port] = config.antidote.host;
			this.antidote[config.antidote.port + 100] = "localhost";
			this.antidote[config.antidote.port + 200] = "localhost";
